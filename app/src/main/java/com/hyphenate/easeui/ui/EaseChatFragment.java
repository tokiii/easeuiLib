...
//                    titleBar.setTitle(user.getNick());
            ...
            titleBar.setLeftImageResource(R.drawable.ease_title_back);
//            titleBar.setBackgroundColor(getResources().getColor(R.color.title_color_chat));
        } else {
